	...
	public MenuItemDaoCollectionImpl() {
		...
		if (menuItemList == null) {
			...
			MenuItem itemTwo = new MenuItem(2, "Burger", 129.00f, true, new DateUtil().convertToDate("23/12/2017"),
					"Main Course", false);
			MenuItem itemThree = new MenuItem(3, "Pizza", 149.00f, true, new DateUtil().convertToDate("21/08/2018"),
					"Main Course", false);
			MenuItem itemFour = new MenuItem(4, "French Fries", 57.00f, false,
					new DateUtil().convertToDate("02/07/2017"), "Starters", true);
			MenuItem itemFive = new MenuItem(5, "Choclate Brownie", 32.00f, true,
